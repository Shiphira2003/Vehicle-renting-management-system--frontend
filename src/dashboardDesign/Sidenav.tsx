...
export const SideNav =()=> {
    return (
        <ul className="menu bg-gray-300 text-dark-300 shadow-lg min-w-full gap-2 text-base-content min-h-full p-4"> 
            ...
            {/* Payments */}
            <li>
                <Link to="payments" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-400">
                    <DollarSign className="text-orange-600 w-5 h-5"/> {/* Changed to DollarSign icon for Payments */}
                    <span className="text-gray-800 text-lg">Payments</span>
                </Link>
            </li>
            {/* Tickets */}
            <li>
                <Link to="tickets" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-400">
                    <Ticket className="text-orange-600 w-5 h-5"/> {/* Changed to Ticket icon for Tickets */}
                    <span className="text-gray-800 text-lg">Tickets</span>
                </Link>
            </li>
            {/* Spacing for Logout and Home */}
            <div className="my-4 border-t border-gray-400"></div> {/* Optional divider for visual separation */}
            ...
            <li>
                <Link to="/" className="flex items-center gap-2 px-4 py-2 rounded-lg hover:bg-gray-400">
                    <Home className="text-green-500 w-5 h-5"/> {/* Lucide Home icon */}
