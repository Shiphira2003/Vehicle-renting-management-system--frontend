...
const Analytics = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-8 bg-gray-50 min-h-screen">
      <h1 className="text-3xl md:text-4xl font-extrabold text-center mb-6 text-orange-400">Admin Dashboard Overview</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        {[{
          ...
          <div key={label} className="bg-white p-4 rounded-xl shadow-md">
            ...
            <Link to={to} className="inline-block mt-3 px-3 py-1 bg-white text-purple-600 rounded hover:bg-red-600">View All</Link>
          </div>
        ))}
      </div>
